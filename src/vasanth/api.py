...
DEFAULT_ENDPOINT = "https://vasanth-relay.vercel.app/api/message"

#: Override for local development: VASANTH_ENDPOINT=http://127.0.0.1:8000/api/message
ENDPOINT = os.environ.get("VASANTH_ENDPOINT", DEFAULT_ENDPOINT).strip()
...
USER_AGENT = "vasanth-cli/%s" % __version__
...
def send_message(message: str, sender_name: str = "Vasanth") -> SendResult:
